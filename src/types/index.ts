import { Role, ListingStatus, ImageStatus, TransactionType, TransactionStatus, VerificationTier, OrderStatus, DisputeStatus, BookingStatus, VerificationStatus } from '../config/constants';
...
export interface Order {
  id: string;
  buyerInfo: { id: string; name: string; profileImage?: string; };
...
export interface Notification {
  ...
  isRead: boolean;
  timestamp: string;
  isAI?: boolean; // New: To identify AI-generated notifications
}
...
// Added CommissionPayout interface
